/**
 * jspsych-image-button-response-reviewing
 * Josh de Leeuw
 *
...
jsPsych.plugins["image-button-response-reviewing"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('image-button-response-reviewing', 'stimulus', 'image');

  plugin.info = {
    name: 'image-button-response-reviewing',
    description: '',
    parameters: {
      stimulus: {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if(typeof trial.choices === 'undefined'){
      console.error('Required parameter "choices" missing in image-button-response-reviewing');
    }
    if(typeof trial.stimulus === 'undefined'){
      console.error('Required parameter "stimulus" missing in image-button-response-reviewing');
    }
   
    // display stimulus
    if (trial.stimulus !== null) {
      display_element.innerHTML = '<div class=""><img id="" src="'+trial.stimulus+'"></img></div>';
    }
    ...
    // display_element.querySelector('#jspsych-image-button-response-btngroup').style.visibility = 'hidden';
    ...
    //     display_element.querySelector('#jspsych-image-button-response-btngroup').style.visibility = 'visible';
